        ...
        <>
                ...
                <Box elevation={3} sx={{
                    ...
                    <Typography variant="h4" fontWeight={700} gutterBottom>
                        Welcome to <span style={{ color: "#1976d2" }}>Srri Kumar's super market</span>!
                    </Typography>
                    <Typography variant="body1" fontSize={18} lineHeight={1.6}>
                        By accessing or using our website at{" "}
                        <a href="https://www.SrriKumarssupermarket.com/" target="_blank" rel="noopener noreferrer" style={{ color: "#1976d2", textDecoration: "none" }}>
                            www.SrriKumarssupermarket.com
                        </a>
                    ...
                    <Typography variant="body1" paragraph>
                        All content on this website, including text, images, logos, and product descriptions, is owned by Srri Kumar's super market or licensed to us. You may not copy, distribute, or reproduce any content without prior written permission.
                    </Typography>
                    ...
                    <Typography variant="body1" fontWeight={600}>
                        Email:Srrikumarssupermarket@gmail.com
                    </Typography>
                    <Typography variant="body1" fontWeight={600}>
                        Phone: +9190033 52535
                    </Typography>
